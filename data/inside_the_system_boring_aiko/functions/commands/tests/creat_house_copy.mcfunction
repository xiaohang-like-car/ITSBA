...
execute if score server/test/hcstage config matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["house_creat_place"],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b}
